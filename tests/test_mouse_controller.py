...
def test_mouse_controller_click(monkeypatch):
    ...
    monkeypatch.setattr(mouse_controller.pag, "click", fake_click)
    ...
    assert mouse_controller.pag.PAUSE == config.pyautogui_pause_seconds
    assert mouse_controller.pag.FAILSAFE == config.pyautogui_failsafe
