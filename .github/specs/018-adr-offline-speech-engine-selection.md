...
- Instruction priority order is Vosk, then faster-whisper, then native APIs.
...
- Comparison summary:
  ...
  - faster-whisper (ctranslate2-backed): higher accuracy, larger models, heavier CPU/GPU usage, still offline but higher resource cost.
