...
class MouseCommand(BaseCommand):
	...
	def __post_init__(self):
		#* Calculate amount per type of command action
		...
		amount_per_type: dict[MouseCommandAction, int] = {
			...
			MouseCommandAction.SCROLL: app_config.mouse_scroll_units if app_config else 0,
			MouseCommandAction.MOVE: app_config.mouse_movement_pixels if app_config else 0,
		}
