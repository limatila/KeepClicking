...
from src.core.config import get_env_or_default, DEBUG_MODE
...
all_loggers = [CORE_LOGGER, ADAPTER_LOGGER, RUNNER_LOGGER, PARSER_LOGGER, VALIDATOR_LOGGER, CONTROLLER_LOGGER]
