...
$CommonArgs = @(
    ...
    "--add-data", "$AssetRoot\mouse-runner-start.mp3;src/resources/assets",
    "--add-data", "$AssetRoot\finishing-loop.mp3;src/resources/assets",
    "--add-data", "$AssetRoot\application-error.mp3;src/resources/assets",
    "--add-data", "$AssetRoot\speech-error.mp3;src/resources/assets",
    "--add-data", "$AssetRoot\parse-error.mp3;src/resources/assets",
    "--add-data", "$AssetRoot\click.mp3;src/resources/assets",
